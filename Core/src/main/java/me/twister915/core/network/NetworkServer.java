...
public interface NetworkServer {
    ...
    /**
     * Gets the number of players online on the {@link me.twister915.core.network.NetworkServer}.
     * @return The number of players online as an {@link java.lang.Integer}
     */
    Integer getOnlineCount();

    /**
     * Gets a list of {@link me.twister915.core.player.COfflinePlayer}s that represent the players currently logged into this server.
     * @return A list of {@link me.twister915.core.player.COfflinePlayer}s
     */
    List<COfflinePlayer> getPlayers();

    /**
     * Transfers a player to this server.
     * @param player The {@link me.twister915.core.player.CPlayer} to transfer to this server.
     */
