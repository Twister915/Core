...
import me.twister915.core.asset.Asset;
import me.twister915.core.player.*;
...
import static me.twister915.core.RandomUtils.safeCast;
import static me.twister915.core.player.mongo.MongoUtils.*;
...
class COfflineMongoPlayer implements COfflinePlayer {
    ...
    final DBObject getObjectForPlayer() {
        ...
        if (this.objectId != null) objectBuilder.add(MongoKey.ID_KEY.toString(), this.objectId); //Will allow us to overwrite the current copy of the user in the database.
