...
public interface CPlayerManager extends Iterable<CPlayer> {
     ...
     * @param uuids The {@link java.util.UUID}s that you want to find the {@link net.communitycraft.core.player.COfflinePlayer}s for.
     * @return A {@link java.util.List} of {@link net.communitycraft.core.player.COfflinePlayer}
     */
    List<COfflinePlayer> getOfflinePlayersByUUIDS(List<UUID> uuids);

    /**
     * Gets an {@link net.communitycraft.core.player.COfflinePlayer} for an {@link org.bukkit.OfflinePlayer} object provided by Bukkit.
     * @param player The {@link org.bukkit.OfflinePlayer} object that you wish to get a {@link net.communitycraft.core.player.COfflinePlayer} for.
     * @return A {@link net.communitycraft.core.player.COfflinePlayer} that represents the {@link org.bukkit.OfflinePlayer} you passed above.
     */
    COfflinePlayer getCOfflinePlayerForOfflinePlayer(OfflinePlayer player);

    /**
     * Gets all currently online players in a collection.
     * @return Online {@link net.communitycraft.core.player.CPlayer}s that are currently online.
     */
    Collection<CPlayer> getOnlinePlayers();

    /**
     * Gets the {@link net.communitycraft.core.player.CPlayer} object that represents the {@link org.bukkit.entity.Player} object from Bukkit.
     * @param player The {@link org.bukkit.entity.Player} from Bukkit to find the {@link net.communitycraft.core.player.CPlayer} for
     * @return {@link net.communitycraft.core.player.CPlayer} instance for this {@link org.bukkit.entity.Player}
     */
    CPlayer getCPlayerForPlayer(Player player);

    /**
     * Gets a {@link net.communitycraft.core.player.CPlayer} that is identified by the unique identifier specified in the parameters.
     * @param uuid The {@link java.util.UUID} representing the UUID of the player.
     * @return A {@link net.communitycraft.core.player.CPlayer} object that represents any matching player, or {@code null} if the player was not found to be online.
     */
     ...
     * @return A {@link net.communitycraft.core.player.CPlayer} instance if the player is found or {@code null} if there is no matching player.
     */
     ...
     * @param player The {@link net.communitycraft.core.player.COfflinePlayer} that you wish to save into the database.
