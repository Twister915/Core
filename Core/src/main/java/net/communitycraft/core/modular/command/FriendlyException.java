...
/**
 * Implement this on any exception that extends {@link net.communitycraft.core.modular.command.CommandException} and the retrun value of the {@link #getFriendlyMessage(ModuleCommand)}
