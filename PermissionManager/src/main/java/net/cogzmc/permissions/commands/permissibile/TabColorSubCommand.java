...
public final class TabColorSubCommand<T extends CPermissible> extends PermissibleSubCommand<T> {
    private final PermissibleResolutionDelegate<T> permissibleResolutionDelegate;

    public TabColorSubCommand(PermissibleResolutionDelegate<T> permissibleResolutionDelegate) {
        super("tabcolor");
